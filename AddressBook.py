...
if __name__ == "__main__":
    try:
        file = open("/Users/gautamsirdeshmukh/PycharmProjects/MyProjects/Data/contacts.txt", "x")
    except FileExistsError:
        pass
    file = open("/Users/gautamsirdeshmukh/PycharmProjects/MyProjects/Data/contacts.txt", "a")
    file = "/Users/gautamsirdeshmukh/PycharmProjects/MyProjects/Data/contacts.txt"
    going = True
    while going:
        run(file)
